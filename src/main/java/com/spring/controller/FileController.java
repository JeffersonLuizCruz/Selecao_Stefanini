...
public class FileController {
	...
	public ResponseEntity<ResponseMessage> uploadFile(@RequestParam("file") MultipartFile file) {
		String message = "";
		try {
			storageService.save(file);// UploadFolder
			storageService.store(file);// Banco de Dados
			storageService.transform(file.getOriginalFilename());// DownloadFolder
	...
	@GetMapping("/files") public ResponseEntity<List<FileInfo>> getListFiles() {
	  ...
	  MvcUriComponentsBuilder .fromMethodName(FileController.class, "getFile",
